...
const userTodos = [
  ...
  userTodos
    ...
    //! c- Birinci kullanıcının (userid si 1 olan) sadece bitirdiği işlerin listesi
  ...
  products
    ...
    products
      ...
      //! d- Firmamız home-decoration categorisine sahip ürünleri ayrı bir sitede yayınlama kararı aldığı için bu ürünleri portföyünden çıkartacak. Bu karategorideki ürünleri listeden çıkaralım.(kalıcı)
  
      products = products.filter(({ category }) => category !== "home-decoration"
      );
  console.log(products);
      
  //! Kullanıcının seçtiği ürünü (id si girilen ürünü) silelim  -delete (silinmiş halini yeni bir diziye aktaralım)
  
  // const id=+prompt("Enter an id:")
  
  // const newArray=  products.filter((ürün)=>ürün.id!==id)
  ...
  //! fiyatları indirimli fiyatlar ile güncelleyelim  - Update
  ...
  //! - Her kategoride kaç ürün olduğunu gösterelim
  ...
  //! eğer sıfırdan bir object in içini elimdeki dizideki verilerden bazılarıyla doldurmak istiyorsam, öncesinde object im boş olduğu için dot notation ile (sayilar.category) yapamam. bu yüzden square bracket kullanmalıyım (  sayilar[category] )